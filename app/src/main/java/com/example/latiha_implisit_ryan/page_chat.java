...
public class page_chat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewMessage = findViewById(R.id.
                text_message);
        penerima = findViewById(R.id.text_header);

        Intent intent = getIntent();
        String kontak = intent.getStringExtra
                (MainActivity.KONTAK);
    ...
    protected void onActivityResult(int requestCode,
        ...
        super.onActivityResult(requestCode,
                resultCode, data);
        if (requestCode == TEXT_REQUEST && resultCode
                == RESULT_OK) {
            String reply = data.getStringExtra
                    (page_chat2.EXTRA_REPLY);
